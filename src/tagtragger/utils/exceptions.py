"""
Custom exception classes for TagTracker
"""

class TagTrackerError(Exception):
    """Base exception class for TagTracker"""
...
class DatasetError(TagTrackerError):
    """数据集相关错误"""
    pass
...
class ImageProcessingError(TagTrackerError):
    """图像处理错误"""
    pass
...
class LabelingError(TagTrackerError):
    """打标相关错误"""
    pass
...
class TrainingError(TagTrackerError):
    """训练相关错误"""
    pass
...
class StorageError(TagTrackerError):
    """存储相关错误"""
    pass

class ConfigError(TagTrackerError):
    """配置相关错误"""
    pass

class ValidationError(TagTrackerError):
    """验证错误"""
