...
from ...config import get_config, DEFAULT_LABELING_PROMPT
...
class LabelingService:
    ...
    def translate_labels(self, 
        ...
        try:
            ...
            if not prompt:
                from ...config.constants import DEFAULT_TRANSLATION_PROMPT
